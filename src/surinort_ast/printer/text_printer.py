...
# Forward-compatible protocol to avoid importing TextPrinter before class definition


class _TextPrinterProtocol(Protocol):
    """Minimal protocol consumed by singledispatch option renderers."""
...
def _print_option_dispatch(
    option: Option, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol
) -> str:
    """
...
def _(option: MsgOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    quote = fmt_opts.get_quote_char()
    return f"msg:{quote}{option.text}{quote};"


@_print_option_dispatch.register
def _(option: SidOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return f"sid:{option.value};"


@_print_option_dispatch.register
def _(option: RevOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return f"rev:{option.value};"


@_print_option_dispatch.register
def _(option: GidOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return f"gid:{option.value};"


@_print_option_dispatch.register
def _(option: ClasstypeOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return f"classtype:{option.value};"


@_print_option_dispatch.register
def _(option: PriorityOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return f"priority:{option.value};"


@_print_option_dispatch.register
def _(option: ReferenceOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return f"reference:{option.ref_type},{option.ref_id};"


@_print_option_dispatch.register
def _(option: MetadataOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
...
@_print_option_dispatch.register
def _(option: ContentOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return printer._print_content(option)


@_print_option_dispatch.register
def _(option: PcreOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    quote = fmt_opts.get_quote_char()
...
@_print_option_dispatch.register
def _(option: FlowOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    sep = fmt_opts.format_list_separator()
    parts: list[str] = []
...
@_print_option_dispatch.register
def _(option: FlowbitsOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return f"flowbits:{option.action},{option.name};"


@_print_option_dispatch.register
def _(option: ThresholdOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    sep = fmt_opts.format_list_separator()
    parts = [
...
@_print_option_dispatch.register
def _(
    option: DetectionFilterOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol
) -> str:
    sep = fmt_opts.format_list_separator()
    parts = [
        f"track {option.track}",
...
@_print_option_dispatch.register
def _(option: BufferSelectOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return f"{option.buffer_name};"


@_print_option_dispatch.register
def _(option: ByteTestOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    sep = fmt_opts.format_list_separator()
    parts = [
...
@_print_option_dispatch.register
def _(option: ByteJumpOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    sep = fmt_opts.format_list_separator()
...
@_print_option_dispatch.register
def _(option: ByteExtractOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    sep = fmt_opts.format_list_separator()
    parts = [
        str(option.bytes_to_extract),
        str(option.offset),
...
@_print_option_dispatch.register
def _(option: FastPatternOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
...
@_print_option_dispatch.register
def _(option: TagOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return f"tag:{option.tag_type},{option.count},{option.metric};"


@_print_option_dispatch.register
def _(option: FilestoreOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
...
@_print_option_dispatch.register
def _(option: LuaOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return f"lua:{option.script_name};"


@_print_option_dispatch.register
def _(option: LuajitOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return f"luajit:{option.script_name};"


@_print_option_dispatch.register
def _(option: NocaseOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return "nocase;"


@_print_option_dispatch.register
def _(option: RawbytesOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return "rawbytes;"


@_print_option_dispatch.register
def _(option: DepthOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return f"depth:{option.value};"


@_print_option_dispatch.register
def _(option: OffsetOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return f"offset:{option.value};"


@_print_option_dispatch.register
def _(option: DistanceOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return f"distance:{option.value};"


@_print_option_dispatch.register
def _(option: WithinOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return f"within:{option.value};"


@_print_option_dispatch.register
def _(option: StartswithOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return "startswith;"


@_print_option_dispatch.register
def _(option: EndswithOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
    return "endswith;"


@_print_option_dispatch.register
def _(option: GenericOption, fmt_opts: FormatterOptions, printer: _TextPrinterProtocol) -> str:
